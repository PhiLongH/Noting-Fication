...
namespace Noting_Fication
{
    public partial class Categories : Form
    {
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                String selectCategory = Note_Categories.SelectedItems[0].Text;
        ...
        public void AddCategoryToListCate(string categoryName)
        {
            ...
            listCate.Nodes.Add(categoryNode);
        }
        //===================================================================================//
        ...
        private void DisplayCategories()
        {
            ...
            foreach (String category in categories)
            {
                ...
                foreach (TreeNode node in catNode.Nodes)
                {
